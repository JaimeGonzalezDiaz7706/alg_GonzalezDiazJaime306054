...
public class NReinas_UO306054 {
    ...
    private void backtracking(int fila, int n, char[][] tablero) {
        ...
        for (int col = 0; col < n; col++) {
            ...
            if(columnas[col]==false && diagonalesPrincipales[d1]==false && diagonalesSecundarias[d2]==false){
    ...
    */
    ...
    public static void main(String[] args) {
        NReinas_UO306054 algoritmo = new NReinas_UO306054();
